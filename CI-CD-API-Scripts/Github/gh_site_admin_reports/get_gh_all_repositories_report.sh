...
# Run this script to download the all_repositories report into your current directory.
...
url="https://code.fs.usda.gov/stafftools/reports/all_repositories.csv"
...
while [ $retry_count -lt $max_retries ]; do
  ...
  if [ "$http_status" -eq 200 ]; then
    ...
    output_file="gh_all_repositories_$timestamp.csv"
