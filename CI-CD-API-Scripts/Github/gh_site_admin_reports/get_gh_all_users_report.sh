...
# Run this script to download the all users report into your current directory.
...
url="https://DOMAIN_NAME/stafftools/reports/all_users.csv"
...
while [ $retry_count -lt $max_retries ]; do
  ...
  if [ "$http_status" -eq 200 ]; then
    ...
    output_file="gh_all_users_$timestamp.csv"
